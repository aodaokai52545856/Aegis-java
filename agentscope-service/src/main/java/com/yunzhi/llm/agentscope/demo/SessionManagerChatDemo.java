...
/**
 * 2.0 使用 {@link JsonFileAgentStateStore} + {@code saveAgentState} 替代 1.x SessionManager。
 */
public class SessionManagerChatDemo {
    ...
    public static void main(String[] args) {
        ...
        if (stateStore.exists(null, SESSION_ID)) {
            agent.getAgentState();
            System.out.println("Session loaded. Messages: "
